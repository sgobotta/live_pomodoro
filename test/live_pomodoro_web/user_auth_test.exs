defmodule LivePomodoroWeb.UserAuthTest do
  @moduledoc false
  use LivePomodoroWeb.ConnCase, async: true

  alias LivePomodoro.Accounts
  alias LivePomodoroWeb.UserAuth
  alias Phoenix.LiveView

  import LivePomodoro.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      ...
      |> Map.replace!(
        :secret_key_base,
        LivePomodoroWeb.Endpoint.config(:secret_key_base)
      )
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LivePomodoroWeb.Endpoint.subscribe(live_socket_id)
