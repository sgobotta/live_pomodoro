...
<h4 align="center">
  Live Pomodoro application written in Elixir
</h4>

<p align="center" style="margin-top: 14px;">
  <a href="https://github.com/sgobotta/live_pomodoro/actions/workflows/ci.yml">
    <img
      src="https://github.com/sgobotta/live_pomodoro/actions/workflows/ci.yml/badge.svg"
      alt="Code Analysis Status"
    >
  </a>
  <a
    href="https://www.codacy.com/gh/sgobotta/live_pomodoro/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=sgobotta/live_pomodoro&amp;utm_campaign=Badge_Grade"
  >
    <img
  ...
  <a href="https://coveralls.io/github/sgobotta/live_pomodoro">
    <img
      src="https://coveralls.io/repos/github/sgobotta/live_pomodoro/badge.svg"
      alt="Test Coverage Status"
    />
  </a>
  <a href="https://github.com/sgobotta/live_pomodoro/blob/main/LICENSE">
    <img
...
The pomodoro app needs the elixir language to be installed. You can install it manually or via the `asdf` package manager, using the fixed version from the *.tool-versions* files
